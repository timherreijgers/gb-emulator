...
class LoadIndirectA16FromATest : public ::testing::Test
{
protected:
...
{
    ON_CALL(m_addressableMock, ReadFromAddress(0x0100)).WillByDefault(::testing::Return(0xEA_b));
    ON_CALL(m_addressableMock, ReadFromAddress(0x0101)).WillByDefault(::testing::Return(0xAA_b));
    ON_CALL(m_addressableMock, ReadFromAddress(0x0102)).WillByDefault(::testing::Return(0xBB_b));
    ...
    EXPECT_CALL(m_addressableMock, ReadFromAddress(0x0102)).Times(1).WillOnce(::testing::Return(0xBB_b));
    EXPECT_CALL(m_addressableMock, WriteToAddress(::testing::_, ::testing::_)).Times(0);
    m_cpu.Step();
    ASSERT_THAT(m_cpu.Registers().zRegister, ::testing::Eq(0xAA_b));
