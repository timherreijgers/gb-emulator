...
constexpr auto ExecuteOrAFromIndirectHL = [](const AddressBus& addressBus, CpuRegisters& cpuRegisters) noexcept -> InstructionHandler {
    ...
    ApplyOrFlags(cpuRegisters, result, 0x00_b);
    co_return;
};
