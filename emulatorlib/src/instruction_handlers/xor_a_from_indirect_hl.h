...
constexpr auto ExecuteXorAFromIndirectHL = [](const AddressBus& addressBus, CpuRegisters& cpuRegisters) noexcept -> InstructionHandler {
    ...
    ApplyXorFlags(cpuRegisters, result, 0x00_b);
    co_return;
};
