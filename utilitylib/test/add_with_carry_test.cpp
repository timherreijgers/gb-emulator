...
INSTANTIATE_TEST_SUITE_P(AddWithCarryTest, AddWithCarryTest, ::testing::Values(
    AddWithCarryTestParam{0, 0, 0b00000000},
    AddWithCarryTestParam{255, 0, 0b00000000},
    AddWithCarryTestParam{10, 5, 0b00000000},
    AddWithCarryTestParam{5, 3, 0b00000111},
    AddWithCarryTestParam{15, 1, 0b00001111},
    AddWithCarryTestParam{127, 1, 0b01111111},
    AddWithCarryTestParam{128, 128, 0b10000000},
    AddWithCarryTestParam{170, 85, 0b00000000},
    AddWithCarryTestParam{100, 100, 0b01100100},
    AddWithCarryTestParam{255, 1, 0b11111111},
    AddWithCarryTestParam{255, 255, 0b11111111},
    AddWithCarryTestParam{200, 100, 0b11000000}
));
